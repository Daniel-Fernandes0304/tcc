...
<div class="formularioss"><b>CADASTRAR</b></p></div>
                <form class="auth_form" method="post" name="formulario" enctype='multipart/form-data'>
                  ...
                  <input type="email" name="email_user" class="input-com-icone-email form-control" placeholder="Email">
                  <label for="senha" class="usu">Senha:</label>
                  <input type="password" name="senha_user" class="input-com-icone-senha form-control" placeholder="Senha">
